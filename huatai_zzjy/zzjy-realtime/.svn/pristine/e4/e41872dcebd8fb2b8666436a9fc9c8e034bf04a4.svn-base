package com.fairyland.jdp.orm.util.ognl;
...
public class OgnlUtil {
	...
	public Object convertValue(Map context, Object root, Member member, String name, Object value, Class toType) {
	    if (OgnlUtil.this.typeConverters.containsKey(toType.getClass())) {
		return ((TypeConverter) OgnlUtil.this.typeConverters.get(toType.getClass())).convertValue(context, root, member, name, value, toType);
	    }
	    return OgnlUtil.this.defaultTypeConverter.convertValue(context, root, member, name, value, toType);
	}
    };
    ...
    @SuppressWarnings("unchecked")
    public <T> T getValue(String name, Map<String, Object> context, Object root, Class<T> resultType) throws OgnlException {
	...
	try {
	    ...
	    ognlContext.setTypeConverter(this.typeConverter);
