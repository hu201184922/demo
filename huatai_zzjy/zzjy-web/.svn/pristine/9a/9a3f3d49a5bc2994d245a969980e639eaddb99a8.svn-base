...
//[描    述] static		Math帮助类
//============================================================
Ace.util.MathUtil = new (Ace.util.jClass((function(){

    return {
        jClass: 'Ace.util.MathUtil',
        ...
        toChinese: function(number,unit,type){
			...
			var numbers = Ace.util.MathUtil.chinese[type].number;
			var units = Ace.util.MathUtil.chinese[type].unit;
...
/**
 * {@link Ace.util.MathUtil#toChinese}的简写方式
 * @member Ace toChinese
 * @method */
Ace.toChinese = Ace.util.MathUtil.toChinese;
/**
 * {@link Ace.util.MathUtil#toInt}的简写方式
 * @member Ace toInt
 * @method */
Ace.toInt = Ace.util.MathUtil.toInt;

Ace.random = Ace.util.MathUtil.random;

Ace.getMax = Ace.util.MathUtil.getMax;

Ace.getMin = Ace.util.MathUtil.getMin;
