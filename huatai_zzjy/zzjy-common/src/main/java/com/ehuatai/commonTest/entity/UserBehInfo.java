...
public class UserBehInfo {
	...
	public Date getLoginTimeNow() {
		return loginTimeNow;
	}

	public void setLoginTimeNow(Date loginTimeNow) {
		this.loginTimeNow = loginTimeNow;
	}
	...
	public void setIsRecent(String isRecent) {
		this.isRecent = isRecent == null ? null : isRecent.trim();
	}
	...
	public void setIsExc(String isExc) {
		this.isExc = isExc == null ? null : isExc.trim();
	}
	...
	public String toString() {
		return "UserBehInfo [behaviorid=" + behaviorid + ", userId=" + userId + ", userName=" + userName + ", dateCode="
				+ dateCode + ", loginTimeNow=" + loginTimeNow + ", loginTimeFirst=" + loginTimeFirst
				+ ", loginTimeLast=" + loginTimeLast + ", isOnline=" + isOnline + ", regeditDate=" + regeditDate
				+ ", isRecent=" + isRecent + ", level=" + level + ", outTime=" + outTime + ", terminalType="
				+ terminalType + ", version=" + version + ", isExc=" + isExc + ", errorInfo=" + errorInfo
				+ ", roleCode=" + roleCode + ", ratioName=" + ratioName + ", ratio=" + ratio + "]";
	}
