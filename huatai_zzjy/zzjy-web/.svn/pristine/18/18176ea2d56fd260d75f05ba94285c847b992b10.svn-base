;(function(){
	$.extend($.fn,{
		Bvalidate:function(options){//表单验证
			var defaults = {
				noEmptyReg:/^\S*$/,  //非空
				//bankNumberReg:/^(998801|998802|622525|622526|435744|435745|483536|528020|526855|622156|622155|356869|531659|622157|627066|627067|627068|627069)\d{10}$/,//银行卡号
				...
				passwordReg:/^[!"#$%&'()*+,\-.:;<=>?@\[\\\]^_`{|}~A-Za-z0-9]{6,20}$/,//密码
				trueNameReg:/^[A-Za-z\u4e00-\u9fa5]+$/,//真实姓名
				tellphoneReg:/^1[3|4|5|7|8][0-9]\d{8}$/,//手机号码
			...
			var self=this,
				value=$(self).val(),
				l=value.length,
				errorText=$(self).attr('data-errorText');
			...
			var S={
				init:function(){
					...
					flag?options.success($(self)):options.error($(self),errorText);
					return flag;
				},
