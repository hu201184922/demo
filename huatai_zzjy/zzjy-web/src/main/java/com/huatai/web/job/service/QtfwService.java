package com.huatai.web.job.service;

public interface QtfwService {

	/*------------------------------预警分析------------------------------*/
	void getWarnData();

	/*------------------------------经营分析------------------------------*/
	void getJYFX_TEMP11_REG01();

	/*------------------------------虚拟区域------------------------------*/

	void getT01_TEMP12_REG01();

	void getT02_TEMP12_REG01();

	void getT03_TEMP12_REG01();

	void getT04_TEMP12_REG01();

	void getT07_TEMP12_REG01();

	void getT08_TEMP12_REG01();

	void getT09_TEMP12_REG01();

	void getP01_TEMP12_REG01();

	void getP02_TEMP12_REG01();

	void getP03_TEMP12_REG01();

	void getP04_TEMP12_REG01();

	void getP05_TEMP12_REG01();

	void getP06_TEMP12_REG01();

	void getP07_TEMP12_REG01();
