    ...
    CityPicker.prototype = {
        ...
        bind: function () {
            ...
            this.$dropdown.on('click', '.city-select a', function () {
                ...
                $this.needBlur = false;
            }).on('click','.clearAddress',function(){
            	$this.reset();
            });
        ...
        feedVal: function () {
        	this.$element.attr("codeValue",this.getCode());
        ...
        output: function (type) {
            ...
            districts = $.isNumeric(code) ? ChineseDistricts[this.$element.attr("homeFlag")][code] : null;
