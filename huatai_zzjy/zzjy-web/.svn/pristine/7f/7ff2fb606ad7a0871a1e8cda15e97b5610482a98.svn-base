...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        //图片上传配置区
        //,imageUrl:URL+"ueditor/jsp/imageUp.jsp"             //图片上传提交地址
        ,imageUrl: request.getContextPath() + "/knowledge/ueditor/uploadImage.do"
        ,imagePath:URL                     //图片修正地址，引用了fixedImagePath,如有特殊需求，可自行配置
        //,imageFieldName:"upfile"                   //图片描述的key,若此处修改，需要在后台对应文件修改对应参数
        //,compressSide:0                            //等比压缩的基准，确定maxImageSideLength参数的参照对象。0为按照最长边，1为按照宽度，2为按照高度
        ,maxImageSideLength:530                    //上传图片最大允许的边长，超过会自动等比缩放,不缩放就设置一个比较大的值，更多设置在image.html中

        //附件上传配置区
        //,fileUrl:URL+"ueditor/jsp/fileUp.jsp"               //附件上传提交地址
        ,fileUrl: request.getContextPath() + "/knowledge/ueditor/uploadFile.do"
        ...
        ,labelMap:{
            ...
            'fontfamily':'字体', 'fontsize':'字号', 'paragraph':'段落格式',  'link':'超链接',
       ...
       // ,pasteplain:false  //是否纯文本粘贴。false为不使用纯文本粘贴，true为使用纯文本粘贴
        ...
        //paragraph
        //段落格式 值:显示的名字
        ,'paragraph':['p:段落','h2:标题1', 'h3:标题 2', 'h4:标题 3', 'h5:标题 4', 'h6:标题 7']
