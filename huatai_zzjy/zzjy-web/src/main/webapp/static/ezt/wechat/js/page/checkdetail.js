				...
				closeCallback:function(){
					...
					$.ajax({
						...
						success:function(data){
							$.Bstatus({html:'加载中'});
							window.location=PATH+'pandian-mx.html?id='+id+'&type='+panel.type;
						},
						error: function(data){
							//error
							/*$.Bstatus({
										...
										for(var i=0;i<d.length;i++){
											var C={
												1:{
													...
													href:PATH+'pandian-mx.html?id='+d[i].uid+'&type=1',
													c:'ui-fk-detail-panel-no'
												},
												2:{
													check:'',
													href:PATH+'pandian-mx.html?id='+d[i].uid+'&type=2',
				...
				error: function(data){
					...
					if(data=='5'){
						...
						$.Bstatus({
							...
							time:500,
							callback:function(){
								window.location='pandian-list.html?type=1';	
							}
						});		
					};
				}
