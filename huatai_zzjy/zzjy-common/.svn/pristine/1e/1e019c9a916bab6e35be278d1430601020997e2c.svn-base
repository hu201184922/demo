...
public enum RestCode {
	...
	AUTHEN_FAILD("A0003","[A0003] 用户信息验证失败"),
	AUTHEN_PHONE("A0004","[A0004]  本手机号尚未关联用户信息"),
	AUTHEN_PASSWORD("A0005","[A0005] 密码修改失败"),
	AUTHEN_LDTOKEN_EXPIRE("A0006","[A0006] 'Token已失效"),
	THRIFT_CLIENT_ERROR("T0000","[T0000]Thrift客户端链接失败"),
	THRIFT_CLIENT_UNKNOW_RESULT("T0001","[T0001]Thrift客户端获取结果失败"),
	THRIFT_CLIENT_RESULT_EXCEPTION("T0001","[T0001]Thrift服务端异常"),
	
	THRIFT_EMPTY("E00001","[E00001] thrift客户无此数据"),
	;
