...
@RestController
@RequestMapping(value="/admin/dict/sys")
public class DictionarySystemController extends TreeController<Dictionary>{
	@Autowired	
	...
	public String main(){
		return "/jdp-framework/dictionary/dictionary-main";
	}
	
	@RequestMapping(value = "/get-tree/sys", produces = MediaTypes.JSON_UTF_8)
	@ResponseBody
	public List<Map<String, Object>> getSysTree() throws Exception {
		Map<String, Object> searchParams=new HashMap<String, Object>();
		searchParams.put("EQ_system", true);
	...
	public String update(@Valid @ModelAttribute("dict") Dictionary dictionary, RedirectAttributes redirectAttributes) {
		...
		return "redirect:/admin/dict/sys/";
	}
	...
	public String createDictItem(@PathVariable("dictid") Long dictid,DictionaryItem dictionaryItem,
		...
		return "redirect:/admin/dict/sys/createDictItempage/{dictid} ";
	}
	...
	public String updateDictItempage(@PathVariable("dictItemId") Long dictItemId,Model model){
		...
		return "/jdp-framework/dictionary/dictionaryItem-update";
	}
	...
	public String updateDictItem(DictionaryItem dictionaryitem,Model model){
		...
		return "redirect:/admin/dict/sys/createDictItempage/"+dictionaryitem.getDictionary().getId();
	}
