...
<%-- <link rel="stylesheet" href="${ctx}/static/lib/jdp/plupload/jquery.plupload.queue/css/jquery.plupload.queue.css" type="text/css" media="screen" /> --%>
...
<!-- Add plupload -->
<%-- <script type="text/javascript" src="${ctx}/static/lib/jdp/plupload/plupload.full.min.js"></script>
<script type="text/javascript" src="${ctx}/static/lib/jdp/plupload/jquery.plupload.queue/jquery.plupload.queue.js"></script> --%>
