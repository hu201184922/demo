...
public class SM2Utils {
	...
	public static void main(String[] args) throws Exception {
		...
		System.out.println("加密密文长度"+cipherText);
		String decryptText = new String(SM2Utils.decrypt(Util.hexToByte(prik), Util.hexToByte(cipherText)));
		System.out.println("加密密文长度"+decryptText);
		
		System.out.println(ByteSource.Util.bytes("www"));
	}
}
