...
import com.fairyland.jdp.framework.security.interceptor.AccessTokenInterceptor;
import com.fairyland.jdp.framework.security.interceptor.AuthInterceptor;
...
//	private UrlLoadingStatusInterceptor urlLoadingStatusInterceptor;
	...
	* @see org.springframework.web.servlet.config.annotation.WebMvcConfigurerAdapter#addInterceptors(org.springframework.web.servlet.config.annotation.InterceptorRegistry)
    ...
    public void addInterceptors(InterceptorRegistry registry) {
    	...
    	InterceptorRegistration accessTokenInterceptorRegistration = registry.addInterceptor(accessTokenInterceptor);
    	accessTokenInterceptorRegistration.addPathPatterns("/**");
    	
    	InterceptorRegistration authInterceptorRegistration = registry.addInterceptor(authInterceptor);
    	authInterceptorRegistration.addPathPatterns(authInterceptor.getPathPattern().split(","));
//    	/**
//    	 * 2.菜单拦截器
//    	 */
...
//    	
    	//InterceptorRegistration logInterceptorRegistration = registry.addInterceptor(logInterceptor);
    	//authInterceptorRegistration.addPathPatterns(logInterceptor.getPathPattern().split(","));
    	/**
    	 * 7.权限加载拦截器
    	 */
