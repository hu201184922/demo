package com.ehuatai.biz.index.fixed.controller;
...
public class FixedController {
	 ...
	 * @return
	 */
	@RequestMapping(value="/fixed/notice")
	public Object indexFixedNotice(@RequestBody Map<String, Object>reqParams,HttpServletRequest request) {
		RequestHeaderUtil.setUserRequestParamter(reqParams, request);
		
		reqParams.put("module",module.indexFixedNotice);
		
		return fixedServiceImpl.fixedNotice(reqParams);
		
	}
	
	/**
	 * 首页->2、固定指标-> 2.4、公告接口 -> 2.4.1、公告详情接口
	 * @param reqParams
	 * @param request
	 * @return
	 */
	@RequestMapping(value="/fixed/notice/detail")
	public Object indexFixedNoticeDetail(@RequestBody Map<String, Object>reqParams,HttpServletRequest request) {
		
		RequestHeaderUtil.setUserRequestParamter(reqParams, request);
		
		return fixedServiceImpl.fixedNoticeDetail(reqParams);
