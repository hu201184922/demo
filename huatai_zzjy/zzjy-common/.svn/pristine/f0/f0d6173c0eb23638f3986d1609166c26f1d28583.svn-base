...
public interface BaseMapper {
	...
	@Select("SELECT DISTINCT PROVCOMCODE AS orgCode,TEAMCOMSHORTNAME AS orgName FROM D_ORGANIZATION WHERE LENGTH (PROVCOMCODE) = 3 ORDER BY 1")
	List<HashMap<String, Object>> getOrgAll();
	
	@Select("SELECT DISTINCT GRADE GRADENAME FROM HT_THREE_ORG_GRADE_DAY_TB ORDER BY 1")
