...
public final class DateUtil {
	...
	public static String getCurrentYear() {
		Calendar calendar = Calendar.getInstance();// 获取当前日期
		calendar.set(Calendar.DAY_OF_MONTH, calendar.getActualMaximum(Calendar.DAY_OF_MONTH));
		return formatDate(calendar.getTime(), YEAR_FORMAT);
	}
	...
	public static String getCurrentYearFirstDay() {
		...
		Calendar calendar = Calendar.getInstance();
		calendar.clear();
		calendar.set(Calendar.YEAR, Integer.parseInt(getCurrentYear()));
	...
	public static String getCurrentWeekFirstDay() {
		...
		if (calendar.get(Calendar.DAY_OF_WEEK) == Calendar.SUNDAY) {
			calendar.setTime(addWeek(calendar.getTime(), -1));
		}
	 ...
	 * @return List<String>
	 */
	public static List<String> getDateBetweenByMonth(String beginDate1, String endDate1) {
		List<String> dateList = new ArrayList<String>();
		Date beginDate;
		Date endDate;
		try {
	...
	public static void main(String args[]) {
		System.out.println(getLastDayOfMonth("2017-01"));
		System.out.println(getLastDayOfMonth("2017-02"));
		System.out.println(getLastDayOfMonth("2017-03"));
		System.out.println(getLastDayOfMonth("2017-04"));
	}
