...
<body>
	<form id="inputForm" name="inputForm" action="${ctx}/admin/sec/role/createPage/"
		method="post" class="form-horizontal" >
		<div class="panel panel panel-info">
				<input type="hidden"
				name="resources_id" id="resources_id" />
			<!-- head -->
			...
			<div class="form-group">
				...
				<div class="col-md-4">
				    <textarea name="descript" id="descript" class="form-control input-sm required"></textarea>
		...
		<div class="panel-footer">
			<div class=" col-md-offset-2">
				<input id="submit_btn" class="btn btn-default" type="submit" value="保存并新增"  />
					...
					<input id="save_btn" class="btn btn-default" type="button" value="保存并关闭" onclick="saveRoleItem()"/>
					<input id="cancel_btn" type="button" class="btn btn-default" value="关闭" onclick="closeCurrent()"/>
		</div>
		</div>
	</form>
	<script>
...
// 								 						}
		...
		// function saveAndAdd(){
			//var roleCateid = document.getElementById("roleCate_id").value;
			//var values =$("#inputForm").serialize();
			//$.ajax({
			//	type:"post",
			//	data:values,
			//	url:"${ctx}/admin/sec/role/createPage/${catagoryid}" ,
			//	success:function(msg){
					//parent.location.reload();
				
					/* this.href = "${ctx}/admin/sec/role/createPage/" + roleCateid; */
			//	}
		//	});
	//	} 
		function saveRoleItem()
	    {
	    	...
	    	if(za.form()){
			    ...
			    $.ajax(
				     ...
				     type : "post",
				     data : values,
				     url : "${ctx}/admin/sec/role/createPage/" ,
				     success : function() 
				     {
