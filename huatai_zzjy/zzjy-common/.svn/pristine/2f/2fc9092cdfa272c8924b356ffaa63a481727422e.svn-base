...
public class RequestHeaderUtil {
	...
	public static void setUserRequestParamter(Map<String, Object>reqParams,HttpServletRequest request) {
		...
		String username = "",role = "", roleDept = "",roleOrg = "",eqp = "";
		if(user != null) {
		...
		reqParams.put("eqp", eqp);
	}
	
	@SuppressWarnings("unchecked")
	public static Map<String, Object> getDownloadParamters(HttpServletRequest request){
		String params = request.getParameter("params");
		Map<String, Object>  reqParams = JSON.parseObject(params, HashMap.class);
		return reqParams;
	}
}
