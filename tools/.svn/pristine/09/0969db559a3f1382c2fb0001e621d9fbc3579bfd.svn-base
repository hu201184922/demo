...
<script type="text/javascript">
	$(function() {
		$('#pager').pager('${pageContext.request.contextPath}/admin/dept/list',15,$('#deptView').view().on('add',function(data){
			(function(zhis){
				...
				deleteConfirm.on('confirm',function(w, t) {
					$.getJSON('${pageContext.request.contextPath}/admin/dept/delete',{id:data.id, dtid:data.dtid},function(bit){
						if(bit==true){
				...
				zhis.target.find('.save').click(function(){
					$.getJSON('${pageContext.request.contextPath}/admin/dept/update',zhis.getData(),function(data){
...
<body>
	...
	<div class="col_lg_04" style="width: 1203px">
		<div class="business_search_list_warp" style="width: 95%">
			...
			<table cellspacing="0" cellpadding="0" class="t-list table"id="deptView">
				<tbody>
					<tr>
						<th width="13%">部门名称</th>
						<th width="13%">对应指标ID</th>
						<th width="13%">部门编码</th>
						<th width="15%">备注</th>
						<th width="5%">排序</th>
					...
					<tr class="tb_tr_content template" name="default">
					 ...
					 <tr class="tb_tr_content template" name="update">
						<td><input style="width: 120px;"
							class="text_wd180 view-field" name="name" type="text"
							 /></td>
						 <td>
						 	<select name="tid" mapping="tid" class="view-field">
						...
						<td><input style="width: 120px;"
							class="text_wd180 view-field" name="code" type="text"
							 /></td>
						<td><input class="text_wd180 view-field" name="remark" type="text"
							/></td>
						<td><input class="text_wd180 view-field" name="sort" type="text"
							/></td>
						<td style="border-right: 1px solid #ccc"><span
							class="span_edit"> <a href="javascript:void(0)"
	...
	<form id="savedeptForm" style="display: none;"
		action="${pageContext.request.contextPath}/admin/dept/create"
		method="post">
		<div id="tagContent2" class="tagContent tagContent_div"
			...
			<table style="line-height: 30px">
				<tbody>
					<tr>
						<td class="text_right">部门名称：</td>
						<td class="text_left"><input name="name" type="text" />
						</td>
					</tr>
					<tr>
						<td class="text_right">指标对应ID：</td>
						<td class="text_left">
						<select name="tid" mapping="tid" class="view-field">
					...
					<tr>
						<td class="text_right">部门编号：</td>
						<td class="text_left"><input name="code" type="text" />
						</td>
					</tr>
					<tr>
						<td class="text_right">备注：</td>
						<td class="text_left"><input name="remark" type="text" />
						</td>
					</tr>
					<tr>
