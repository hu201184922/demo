 ...
 */
Ace.util.JSON = new (Ace.util.jClass((function(){
        ...
        for (i = 0; i < l; i += 1) {
            ...
            switch (typeof v) {
                ...
                default:
                    ...
                    a.push(v === null ? "null" : Ace.util.JSON.encode(v));
                    b = true;
            }
        }
        a.push("]");
...
/**
 * {@link Ace.util.JSON#encode}的简写方式
 * @member Ace encode
 * @method */
Ace.encode = Ace.util.JSON.encode;
/**
 * {@link Ace.util.JSON#decode}的简写方式
 * @member Ace decode
 * @method */
Ace.decode = Ace.util.JSON.decode;
