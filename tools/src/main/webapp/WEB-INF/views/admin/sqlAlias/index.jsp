...
<script type="text/javascript">
	$(function() {
		$('#pager').pager('${pageContext.request.contextPath}/admin/sqlAlias/list',15,$('#parameterView').view().on('add',function(data){
			(function(zhis){
				...
				deleteConfirm.on('confirm',function(w, t) {
					...
					$.post('${pageContext.request.contextPath}/admin/sqlAlias/delete',{id:data.saId},function(bit){
						if(bit==true){
				...
				zhis.target.find('.save').click(function(){
					$.getJSON('${pageContext.request.contextPath}/admin/sqlAlias/update',zhis.getData(),function(data){
...
<body>
	<div class="business_title">SQL别名管理</div>
	<div class="col_lg_04" style="width: 1203px">
		<div class="business_search_list_warp" style="width: 95%">
		 	...
		 	<div class="business_search">
				<div class="business_search_left" style="margin-left: -20px;">
					<form id="parameterAjaxForm"
						action="${pageContext.request.contextPath}/admin/sqlAlias/list"
						method="post">
						<input type="hidden" name="pageSize" value="15" />
						<table>
							<tbody>
								<tr>
									<td style="text-align: right">关联表名：</td>
									<td>
									<input style="width: 300px;height: 30px;border-radius: 5px;border:1px solid #90C1E6;" type="text"
										name="tableName"  class="text">
									</td>
								</tr>
								<tr>
			...
			<table cellspacing="0" cellpadding="0" class="t-list table"id="parameterView">
				<tbody>
					<tr>
						<th width="150px">关联表名</th>
						<th width="100px">别名</th>
						<th width="40px">操作状态</th>
					...
					<tr class="tb_tr_content template" name="default">
					 ...
					 <tr class="tb_tr_content template" name="update">
						<td >
						<input class="view-field" name="tableName" type="text"/>
						</td>
						<td> <input
							style="width: 120px;" class="view-field" name="aliasName"
							type="text"  /></td>
						<td>{opType:dict({A:'新增',D:'删除',U:'更新',R:'查看'})}</td>
						<td>{createTime}</td>
						<td>{modifyTime}</td>
	...
	<form id="saveParameterForm" style="display: none;"
		action="${pageContext.request.contextPath}/admin/sqlAlias/create"
		method="post">
		<div id="tagContent2" class="tagContent tagContent_div"
			...
			<table style="line-height: 30px">
				<tbody>
					...
					<tr>
						<td class="text_right">关联表名：</td>
						<td class="text_left"><input name="tableName" type="text"
							style="border-radius:5px; width:200px;height: 30px;border:1px solid #90C1E6;"></input></td>
					</tr>
					<tr><td height="20px" colspan="2"></td></tr>
					<tr>
						<td class="text_right">别名：</td>
						<td class="text_left"><input name="aliasName" type="text"
							style="border-radius:5px; width:200px;height: 30px;border:1px solid #90C1E6;"></input></td>
					</tr>
