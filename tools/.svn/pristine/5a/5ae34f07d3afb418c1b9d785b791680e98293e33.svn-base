	...
	<script>
		$(document).ready(function() {
			...
			$("#inputForm").validate({
				rules: {
					loginName: {
						remote: "${ctx}/jdp-framework/register/checkLoginName"
					}
				},
				messages: {
					loginName: {
...
<body>
	<form id="inputForm" action="${ctx}/jdp-framework/register" method="post" class="form-horizontal">
		<fieldset>
			...
			<div class="form-actions">
				<input id="submit_btn" class="btn btn-default" type="submit" value="提交"/>&nbsp;	
