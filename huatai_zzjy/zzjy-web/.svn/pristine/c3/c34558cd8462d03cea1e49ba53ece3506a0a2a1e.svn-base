		...
		getSelected: function() {
			...
			switch (type) {
				...
				case 'time':
					...
					break;
				case 'month':
					selected.value = selected.y.value + '年' + selected.m.value+ '月';
					selected.text = selected.y.text + '年' + selected.m.text+ '月';
					break;
				case 'year':
					selected.value = selected.y.value + '年' ;
					selected.text = selected.y.text + '年' ;
					break;	
				case 'hour':
			...
			document.getElementById("currdateyear").value=selected;
			document.getElementById("dianji").click();
			return selected;
		},
