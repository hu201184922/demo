...
/**
 * 日期属性编辑抽象类，用于spring中对日期属性的支持
 * @author XiongMiao
 *
 */
public abstract class AbstractDateEditor extends PropertyEditorSupport{
	 ...
	 */
	public AbstractDateEditor(DateFormat dateFormat, boolean allowEmpty) {
	 ...
	 */
	public AbstractDateEditor(DateFormat dateFormat, boolean allowEmpty, int exactDateLength) {
		this.dateFormat = dateFormat;
		this.allowEmpty = allowEmpty;
	...
	public abstract Date getValue(Date date);
}
